...
import { ErrorResponse } from "~/app/_components/types/mangadex";
 ...
 * @param {RequestInit} [options] Additional request options (such as request body, headers, etc.)
 ...
 * @param {RequestInit} [request] RequestInit object to add the token to
 * @returns A new {@link RequestInit} object with the added authorization token
 */
